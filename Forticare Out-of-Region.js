...
$(document).ready(function () {
    ...
    const SHAREPOINT_LINK = 'https://fortinet.sharepoint.com/:x:/r/sites/APACLoadStat-APACOORHandling/_layouts/15/Doc.aspx?sourcedoc=%7B64A9B8FE-1B20-4A21-9F00-9152EDDBCDF9%7D&file=OOR%20Tracker.xlsx&action=default&mobileredirect=true';

    const engineerData = {
        'Manila': ['Aaron Chu','Aristeo Quilingan','Arnold Dimailig','Carnil De Lara','Constantin Avellano','Denice De Guzman','Elmer Malayan','Franco Dettori Santos','Franklin Terence Conag','Innah Valerie Bituya','Jackquelyn Era','Jezza Paula Hernandez','Jeferson Bernabe','Jeric Añonuevo','John Michael Lim','Jordan Clar','Kristelle Corinne Andawi','Lars Rayson Bollas','Mar Pugahac','Nico Angelo Abanes','Paulo Dela Pena','Pearl Angelica Chavez','Reybin Villaroman','Reynante Aureada','Ricky Tanagras','Ronmar Galvez','Ruther Ivan Bernal','Ryan Jose','Sherman Joseph Pasquil','Stephen Yao'],
